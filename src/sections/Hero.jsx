...
const Hero = () => {
  ...
  return (
    <section
      className="min-h-screen max-w-7xl mx-auto w-full flex flex-col relative"
      id="home"
    >
      <div className="w-full mx-auto flex flex-col sm:mt-36 mt-20 c-space gap-3">
        <motion.p
          ...
          className=" text-3xl font-medium text-white text-center font-generalsans"
        >
          Hi, I am Rowel
      ...
      <div ref={ref} className="w-full h-full absolute inset-0">
        {/* <Leva /> */}
        {isMobile
          ? inView && mainLoad(isMobile, sizes)
          : mainLoad(isMobile, sizes)}
      </div>
      <div className="absolute bottom-7 left-0 right-0 z-10 c-space w-fit mx-auto">
        <a href="#about" className="w-fit">
          <Button
            name="Let's work togethter"
            isBeam
